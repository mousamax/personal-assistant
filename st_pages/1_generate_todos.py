...
# Collect user input
user_query = st.text_input("Tell us what’s happening (e.g., “My child is sick and needs to be picked up from kindergarten”)", placeholder="Explain your situation here...")
